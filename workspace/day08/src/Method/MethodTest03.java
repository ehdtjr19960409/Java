...
public class MethodTest03 {
	public static void main(String[] args) {
		...
		//매개변수X, 리턴값O 메소드 printTotal => syso(printTotal());
		System.out.println("1부터 10까지의 합 : "+ mt.printTotal());
		
		//매개변수O, 리턴O 메소드 syso(printNum()) or 변수 = printNum(인수);
		System.out.println("1부터 num까지의 합 : " + mt.printNum(5));
		System.out.println("1부터 num까지의 합 : " + mt.printNum(3));
	...
	//매개변수o, 리턴값o 메소드
	//정수 1개를 넘겨받아 1~넘겨받은 정수까지의 합을 반환해주는 메소드
	//매개변수로 전달된 값을 출력
	//최종 합을 반환
	//메소드명 : printNum
	//매개변수 : 1개
