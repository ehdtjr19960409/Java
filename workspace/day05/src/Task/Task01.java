...
//      청소년입니다
		...
		// 나이 정수 선언
		// 입력메소드 선언
		// if(0~12므로 AND 필수), else if(13~19므로 AND 필수), else if(20세 이상 조건식) else{음수입니다}로
		// 어린이 청소년 성인을 구분하는 조건식을 생성
...
//         출력 : 1 5 9
		...
		resultMiddle = ((num01 != resultSmall) && (num01 != resultBig)) ? num01
				: ((num02 != resultSmall) && (num02 != resultBig)) ? num02 : num03;
...
//	   		break;
		...
		String msg = ("\nATM 메뉴의 번호를 선택하세요 : " + "1. 잔액 조회" + "2. 입금" + "3. 출금" + "4. 종료" + "선택 : ");
