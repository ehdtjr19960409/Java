...
public class MarvelHero {
	...
	//모든 필드 내용 출력
	void printInfo() {
		System.out.println("이름 : " + this.name); 		//this 추가
		System.out.println("특성 : " + this.superpower);	//this 추가
		System.out.println("나이 : " + this.age );			//this 추가
	...
	void performAction() {
		...
		System.out.println(name + "이/가 " + superpower +"을 " + "사용합니다." );
