...
//		메모리와 같이 정리
		int a;	//RAM에서 상자를 만들고 그 상자의 이름을 a로 지정
		a = 100; // a 상자에 100 정수형 값을 저장한다
		// 이 a 상자는 RAM의 특정 주소값을 가진다
